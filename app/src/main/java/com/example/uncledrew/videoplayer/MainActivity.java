...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button otherText = findViewById(R.id.otherText);
        Button viewText = findViewById(R.id.viewText);
        ...
        otherText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this,OtherTextActivity.class);
                startActivity(intent);
            }
        });
